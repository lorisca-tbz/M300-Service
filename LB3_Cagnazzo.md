...
In diesem Projekt habe ich sehr vieles gelernt. Ich hatte zuvor noch nie mit mit Git oder mit Docker gearbeitet. Mit Docker musste ich im Geschäft nur mit Docker Compose einen Passwortmanager aufsetzen. Aber ich konnte durch dieses Modul in die Tiefe und die Konfigurationen sehr gut verstehen. Zuerst wollte ich diese Umgebung auf meinem Laptop bauen, aber da ich immerwieder Probleme hatte, einmal hatte ich HyperV an.
